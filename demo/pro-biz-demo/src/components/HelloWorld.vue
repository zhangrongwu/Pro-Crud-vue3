...
<script setup lang="ts" name="hellow">
import { reactive, ref } from "vue";
import ElProForm from "pro-biz/src/pro-form/pro-form.vue";
import ElProTable from "pro-biz/src/pro-table/pro-table.vue";
...
const formConfig = reactive({
  ...
  size: "default",
  disabled: false,
  validate: (val: any, val1: any, val2: any) => {
    console.log("====================================");
    console.log();
    console.log("====================================");
...
const handleEditBtnClick = (rowData: any, btnItem: any) => {
